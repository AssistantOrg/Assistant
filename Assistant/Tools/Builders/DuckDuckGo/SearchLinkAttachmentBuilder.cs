...
namespace Rovecode.Assistant.Tools.Builders.DuckDuckGo
{
    public class SearchLinkAttachmentBuilder : LinkAttachmentBuilder<SearchLinkAttachmentBuilder>
    {
            ...
            : base(context)
        {
            ...
            {
                Source = Facade.Enums.WebSource.DuckDuckGo
            };
        }
        ...
        {
            _value.Link = new Uri($"https://duckduckgo.com/?q={String.Join("+", linkKey)}");
            return this;
        }
